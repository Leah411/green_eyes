...
export default function Sidebar({ showSidebar, setShowSidebar, userRole = '' }: SidebarProps) {
  ...
  return (
    <>
      ...
      />
      <div className="fixed right-0 top-0 h-screen w-80 bg-white shadow-2xl z-[100] flex flex-col" dir="rtl">
      ...
      <div className="sticky bottom-0 bg-white border-t border-gray-200 p-4">
        <button
          ...
          className="w-full text-right p-4 bg-red-50 hover:bg-red-100 rounded-lg border border-red-200 hover:border-red-300 transition-all flex items-center justify-between"
        >
          <span className="font-semibold text-red-700">התנתק</span>
